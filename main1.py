...
def get_args(argv):
    ...
    # Dataset
    parser.add_argument('--datapath', type=str, default='./datasets/augdata/')
    parser.add_argument('--dataname', type=str, default='AgNews_trans_subst_20', help="")
    ...
    # Learning parameters
    parser.add_argument('--lr', type=float, default=1e-5, help="learning rate for ")
